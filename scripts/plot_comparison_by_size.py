...
data = {
    ...
    # F1 scores from the updated LaTeX results table
    "16-class": [21.9, 25.0, 15.4, 21.6, 24.0, 25.7, 26.6, 27.7, 25.9],
    "Fall": [65.6, 65.8, 60.8, 64.8, 67.7, 67.4, 67.1, 72.4, 68.5],
    "Fallen": [41.0, 39.3, 8.7, 9.2, 11.1, 29.7, 27.6, 38.2, 28.4],
}
